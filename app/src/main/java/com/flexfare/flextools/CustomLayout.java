...
import com.flexfare.flextools.CustomLayoutSetup.Direction;
import com.flexfare.flextools.CustomLayoutSetup.Position;
...
public class CustomLayout extends FrameLayout{
    ...
    public void init(Context context, AttributeSet attrs) {
        settings = new CustomLayoutSetup(context, attrs);
