...
@SuppressWarnings({"FieldCanBeLocal", "InflateParams", "RtlHardcoded", "unused", "WeakerAccess", "unchecked", "unsafe"})
public class FloatingNav extends FloatingActionButton {
    ...
    public FloatingNav(Context context) {
        this(context, null);
    }

    public FloatingNav(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FloatingNav(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return FloatingNav.class.getSimpleName() + "." + SavedState.class.getSimpleName() + "{"
