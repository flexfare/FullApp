package com.flexfare.android.social.managers;
...
import com.flexfare.android.social.Constants;
...
import com.flexfare.android.social.managers.listeners.OnPostListChangedListener;
import com.flexfare.android.social.managers.listeners.OnProfileCreatedListener;
...
import com.flexfare.android.social.utils.LogUtil;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public Task<Void> removeImage(String imageTitle) {
        StorageReference storageRef = storage.getReferenceFromUrl("gs://fbfeed-d9e1e.appspot.com");
